...
client.on("friendMessage", function(steamID, message) {
    if (message == "hi") {
        ...
        client.chatMessage(steamID, "Hello, my name is Jewdoria and I am an automated bot made by my owner, Dread. Feel free to send me a trade offer. I trade items in team fortress 2. I will accept any offer if it profits me.");
    }
